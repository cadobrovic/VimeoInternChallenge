            ...
            <div className="slide">
                ...
                <div className="content">
                    ...
                    <div className="text">
                        ...
                        <div className="links">
                            <a 
                                href={"https://vimeo.com/store/ondemand/buy/"+this.props.buy} 
                                className="buy pointer" 
                                style={buttonColor}><svg 
                                viewBox="0 0 25 25" 
                                width="25" 
                                height="25"><path 
                                class="fill" 
                            ...
                            <a 
                                href={"https://player.vimeo.com/video/"+this.props.watch} 
                                className="watch pointer">
                                Watch Trailer
                            </a>
                        </div>
                    </div>
